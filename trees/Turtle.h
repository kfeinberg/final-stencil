...
const float theta = 22.5;
const float f_dist = 0.3f;
...
public:
    ...
    float m_roll; // degree of roll (rotation around x)
    float m_pitch; // degree of pitch (rotation around y)
    float m_yaw; // degree of yaw (rotation around z)
};
